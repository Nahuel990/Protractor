...
describe("Register Results: Committee Evaluation 3", function () {
   ...
   it("Vote",function () {
    ...
    it("Restore Session", function () {
        ...
        var buscar = element(by.xpath("//*[@id='page-wrapper']/div[2]/div[1]/div/div/div[2]/div/div/div/div[2]/div[1]/div/input"));
